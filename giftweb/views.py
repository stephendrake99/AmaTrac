...
def products_by_category(request, category_name):
    ...
    products = category.products.all()  # Access products through the category's related_name
...
def home(request):
    ...
    return render(request, 'giftweb/index.html', {'categories': categories,'products': products})
